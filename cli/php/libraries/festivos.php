...
class festivos
{
	//http://blog.iguazoft.com/festivos-de-colombia-en-php/
	//http://blog.iguazoft.com/wp-content/uploads/2011/03/festivos.zip
	...
	public function festivos($ano = '')
	{
		...
		$this->festivos[$ano][8][7]   = true;		// Batalla de Boyac� 7 de Agosto
		...
		$this->otrasFechasCalculadas(40, true);		//Ascenci�n el Se�or pascua
